		...
		echo '<form method="post" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-md-6 col-xs-12">
						...
						<h2>Nombre:</h2>
						<input type="text" class="input-lg form-control" name="nombreP" value="'.$resultado["nombre"].'">
						<input type="hidden" class="input-lg form-control" name="Aid" value="'.$resultado["id"].'">

						<h2>Apellido:</h2>
						<input type="text" class="input-lg form-control" name="apellidoP" value="'.$resultado["apellido"].'">

						<h2>Usuario:</h2>
						<input type="text" class="input-lg form-control" name="usuarioP" value="'.$resultado["usuario"].'">

						<h2>Contraseña:</h2>
						<input type="text" class="input-lg form-control" name="claveP" value="'.$resultado["clave"].'">
					...
					<div class="col-md-6 col-xs-12">
						...
						if($resultado["foto"] == ""){
							...
							echo '<img src="http://localhost/Clinica/Vistas/img/defecto.png" width="40px;">';

						}else{

							echo '<img src="http://localhost/Clinica/'.$resultado["foto"].'" width="40px;">';
